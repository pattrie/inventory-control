...
public class ProductService {
  ...
  private List<StoragePlace> getStoragePlaces(ProductRequestDto productDto) {
  ...
  private Supplier getSupplier(ProductRequestDto productDto) {
    final Supplier supplier = productDto.getSupplier().convertJsonToEntity();
    return supplierRepository.save(supplier);
  }

  private Category getCategory(ProductRequestDto productDto) {
